...
if 'man_x' not in st.session_state:
    st.session_state['man_x'] = 'A'
if 'man_y' not in st.session_state:
    st.session_state['man_y'] = '1'
...
if st.session_state.get('man_x') not in _x_labels:
    st.session_state['man_x'] = _x_labels[0]
if st.session_state.get('man_y') not in _y_labels:
    st.session_state['man_y'] = _y_labels[0]
